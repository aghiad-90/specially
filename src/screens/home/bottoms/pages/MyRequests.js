...
class MyRequests extends Component {
    ...
    fetchRequests() {
        ...
        setTimeout(() => {
            var url = 'request?requestBy=' + this.props.data.userInfo._id;
            if (this.state.type !== '')
    ...
    render() {
        return (
            <Block>
                ...
                <Header search={false} backPrimary={false} back={true} navigation={this.props.navigation} backclick={() => { this.props.navigation.pop() }} Text={translate('My Requests')} />
                    ...
                    <View style={{ width: '95%', height: '100%', flexDirection: 'row', justifyContent: 'center' }}>
                        <ScrollView showsVerticalScrollIndicator={false} style={{ marginBottom: moderateScale(250) }}>
                            <View style={{ padding: 10, paddingStart: -10 }} >
                                ...
                                <View style={{
                                    backgroundColor: theme.colors.white, marginTop: moderateScale(0), margin: moderateScale(5)
                                }}>
                                    {this.state.requests.length !== 0 &&
                                        <FlatList
                                            data={this.state.requests}
                                            showsVerticalScrollIndicator={false}
                                            contentContainerStyle={{ marginTop: moderateScale(0), marginBottom: moderateScale(40) }}
                                                ...
                                                <View
                                                    ...
                                                    <TouchableOpacity onPress={() => {
                                                        ...
                                                        <View style={{ width: '100%', zIndex: 0, marginTop: moderateScale(0) }}>
                                                            ...
                                                            }]}>{item.requestTo.first_name + ' ' + item.requestTo.last_name}</Text>
                            ...
                            <View style={{
                                ...
                                <View style={{
                                    ...
                                    <View style={{ paddingHorizontal: moderateScale(20), marginTop: moderateScale(10) }}>
                                        ...
                                        }]}>{translate('Celeberaty name')}</Text>
                                        ...
                                        <View style={{ borderRadius: moderateScale(10), backgroundColor: theme.colors.gray06, borderRadius: moderateScale(10), paddingVertical: moderateScale(10), paddingHorizontal: moderateScale(25) }}>
                                            ...
                                            }]}>{this.state.selectedRuquest.requestTo.first_name + ' ' + this.state.selectedRuquest.requestTo.last_name}</Text>
                                        </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(React.memo(MyRequests))