  ...
  render() {
    return (
      <View style={this.props.style}>
        <View style={[styles.image, this.props.style, { tintColor: theme.colors.primary, alignSelf: 'center', }]}>
          {/* <Image
            resizeMode='contain'
            style={[styles.image, this.props.style, { tintColor: theme.colors.primary, }]}
            onError={() => { console.log('Shit Happen ') }}
          // source={require('app/assets/noimage.png')}
          /> */}
        </View>
        <Animated.Image
